...
public class ServidorHilo extends Thread{
	...
	public String validarCliente(Operaciones op) {
		int intentos = 0 ;
       	...
       	String queryDni = "select dni,loggin from usuario where username = '"+op.getUsuario()+
       			"' and password = '"+p+"';";
       	try {
       		...
       		if(resultado.next()) {//si existe la consulta, usuario okey
       			...
       			if(!loggin.equals("0")) {//para ver si esta loggiado
       				...
       				this.dBase.st.executeUpdate(queryLoggin);// seteo loggin a uno, indicando usuario loggiado
